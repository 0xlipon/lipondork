...
'XSS Injection': [
    ...
    'inurl:"search?q="',
    'inurl:"?query=aaa"',
    'inurl:"en-us/Search#/?search="',
    'inurl:"Search/Results?q="',
    'inurl:"q="',
    'inurl:"foo?q="',
    'inurl:"search.php?query="',
    'inurl:"en-us/search?q="',
    'inurl:"s="',
    'inurl:"find?q="',
    'inurl:"result?q="',
    'inurl:"query?q="',
    'inurl:"search?term="',
    'inurl:"search?query="',
    'inurl:"search?keywords="',
    'inurl:"search?text="',
    'inurl:"search?word="',
    'inurl:"find?query="',
    'inurl:"result?query="',
    'inurl:"search?input="',
    'inurl:"search/results?query="',
    'inurl:"search-results?q="',
    'inurl:"search?keyword="',
    'inurl:"results?query="',
    'inurl:"search?search="',
    'inurl:"search?searchTerm="',
    'inurl:"search?searchQuery="',
    'inurl:"search?searchKeyword="',
    'inurl:"search.php?q="',
    'inurl:"search/?query="',
    'inurl:"search/?q=aaa"',
    'inurl:"search/?search="',
    'inurl:"search.aspx?q="',
    'inurl:"search.aspx?query="',
    'inurl:"search.asp?q="',
    'inurl:"index.asp?id="',
    'inurl:"dashboard.asp?user="',
    'inurl:"blog/search/?query="',
    'inurl:"pages/searchpage.aspx?id="'
],
'LFI': [
    'inurl:"index.php?page="',  
    'inurl:"page.php?file="',  
